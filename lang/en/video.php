...
$string['control_download'] = 'Download button';
$string['control_duration'] = 'Duration of video';
$string['control_fast-forward'] = 'Fast forward by a few seconds';
$string['control_fullscreen'] = 'Fullscreen toggle';
$string['control_mute'] = 'Mute toggle';
$string['control_pip'] = 'Picture-in-picture';
$string['control_play'] = 'Play/pause playback';
$string['control_play-large'] = 'Center play button';
$string['control_progress'] = 'Progress bar';
$string['control_restart'] = 'Restart playback';
...
$string['enabledebug_help'] = 'Display debugging information in the console';
$string['externalurl'] = 'URL';
$string['firstaccess'] = 'First access';
$string['fullscreenenabled'] = 'Fullscreen enabled';
$string['hidecontrols'] = 'Hide controls after 2 seconds';
$string['invalidcontrol'] = 'Unknown option provided';
$string['lastaccess'] = 'Last access';
$string['loop'] = 'Loop';
$string['modulename'] = 'Video';
$string['modulename_help'] = 'Long description here.';
...
$string['numviews'] = '{$a->views} view';
$string['numviews_plural'] = '{$a->views} views';
...
$string['privacy:metadata:video_session:lasttime'] = 'The time when the user last left the video session.';
$string['privacy:metadata:video_session:maxtime'] = 'The furthest point in time the user has reached in the video.';
$string['privacy:metadata:video_session:timecreated'] = 'The time this video session was created.';
$string['privacy:metadata:video_session:timemodified'] = 'The time this video session was last modified.';
$string['privacy:metadata:video_session:userid'] = 'The ID of the user for this video session.';
$string['privacy:metadata:video_session:watchpercent'] = 'The percentage of the video watched by the user.';
$string['privacy:metadata:video_session:watchtime'] = 'The time the user has watched the video.';
...
$string['searchforvideos'] = 'Search for videos...';
...
$string['topresults'] = 'Showing the top 10 results.';
